-- FreshLink standalone MySQL installer (MySQL 8.4).
-- Generated by: python database/build_sql.py -- do not edit manually.
-- Includes schema and reference/catalogue seed data through Flyway V6.
...
-- ===== END V2__api_tokens.sql =====

-- ===== BEGIN V3__request_deduplication.sql =====
...
-- ===== END V3__request_deduplication.sql =====

-- ===== BEGIN V4__receipt_quantities.sql =====
...
-- ===== END V4__receipt_quantities.sql =====

-- ===== BEGIN V5__settlement_uniqueness.sql =====
...
-- ===== END V5__settlement_uniqueness.sql =====

-- ===== BEGIN V6__cloudinary_media.sql =====
...
-- ===== END V6__cloudinary_media.sql =====

SELECT 'FreshLink schema and reference data imported successfully' AS result;
